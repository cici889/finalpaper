...
We plan to use a generalized linear regression model for prediction. Among all these 7 predictors, we find that time spent with family, self-rated health, workload management  have the most predictive effect. Therefore, we obtain a logistic regression model with these predictors using the function glm (we used the dplyr and tidyverse packages (@citedplyr @citetidyverse) in R (@citeR).)
